    ...
    <Header>
      <Box w="100%" my="5">
        ...
        <SimpleGrid spacing="5" templateRows="auto" templateColumns="1fr 1fr" w="100%" my={6}>
          <Box>
            <Text color="#010C14" fontSize="12px">
              Gross Payment
            </Text>
            <Text color="#0AAF60">+ USD 4,500.00</Text>
          </Box>
          <Flex direction="column" alignItems="end">
            <Text color="#010C14" fontSize="12px">
              Income Tax
            </Text>
            <Text color="#E71D36">- USD 200.00</Text>
          </Flex>
          <Box>
            <Text color="#010C14" fontSize="12px">
              Health Insurance
            </Text>
            <Text color="#E71D36">- USD 500.00</Text>
          </Box>
          <Flex direction="column" alignItems="end">
            <Text color="#010C14" fontSize="12px">
              Pension
            </Text>
            <Text color="#E71D36">- USD 100.00</Text>
          </Flex>
        </SimpleGrid>
