       ...
       <Stack flex={1} >
        ...
        <Flex flex={1} align={{ base: '', md: 'start' }} p={12}>
          <Stack spacing={8} w={'full'} maxW={'md'}>  
              ...
              <Stack>
                <Text color={'primary.100'} fontWeight={'bold'} fontSize={{ base: '3xl', md: '4xl' }}>Create Account</Text>
                <Text color="muted">
                  Already have an account? <Link color='primary.main' href="/employee/login">Login</Link>
                </Text> 
              </Stack>
